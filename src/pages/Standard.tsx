...
const OPTIONS = [
  { id: "diag", label: "Diagnostic avancé + optimisation", price: 25.0 },
  { id: "prio", label: "Support prioritaire (48h)", price: 15.0 },
  { id: "install-office", label: "Installation Office + activation", price: 19.0 },
];
...
export default function Standard() {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({ id: "pack-standard", title, price: total, qty: 1 });
    alert("✅ Pack Standard ajouté au panier !");
  };

  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950 dark:text-neutral-100">
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <h1 className="text-4xl font-extrabold">Standard</h1>
        <p className="text-gray-600 dark:text-neutral-300 mt-2">
          Diagnostic poussé et prise en charge prioritaire.
        </p>
